...
RUN mkdir //.meteor-install-tmp && chown 1000050000:root //.meteor-install-tmp && chmod a+rwxt //.meteor-install-tmp && chmod a+x /app/run.sh && chmod -R a+rwx /app && chown 1000050000:root /app
